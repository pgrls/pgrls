...
| [`README.md`](../README.md)           | Bump the rule count (`50 lint rules` → `51`) in the badges/intro/feature line, and add a row to the rules table. |
...
count (`50 lint rules`, `fifty rules`, etc. — the phrasing
