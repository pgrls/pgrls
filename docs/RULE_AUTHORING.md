...
| [`README.md`](../README.md)           | Bump the rule count (`66 lint rules` → `67`) in the badges/intro/feature line, and add a row to the rules table. |
...
count (`66 lint rules`, `sixty-six rules`, etc. — the phrasing
