...
| [`README.md`](../README.md)           | Bump the rule count (`67 lint rules` → `68`) in the badges/intro/feature line, and add a row to the rules table. |
...
count (`67 lint rules`, `sixty-seven rules`, etc. — the phrasing
