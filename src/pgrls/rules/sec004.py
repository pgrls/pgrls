            ...
            for policy in table.policies:
                ...
                if anon_roles & set(policy.roles):
                    ...
                    message = (
                        ...
                        "cannot reach it UNLESS anon inherits that role "
                        "(`GRANT authenticated TO anon` — measured: a "
                        "token-less session then read every row; a NOINHERIT "
                        f"member read none) — but the disjunct still "
