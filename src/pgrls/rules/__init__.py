...
Every built-in rule (SEC001-SEC055, PERF001-PERF005, HYG001-HYG004,
...
def _build_default_registry() -> RuleRegistry:
    ...
    registry.register(SEC042())
    registry.register(SEC043())
    registry.register(SEC044())
    registry.register(SEC045())
    registry.register(SEC046())
    registry.register(SEC047())
    registry.register(SEC048())
    registry.register(SEC049())
    registry.register(SEC050())
    registry.register(SEC051())
    registry.register(SEC052())
    registry.register(SEC053())
    registry.register(SEC054())
    registry.register(SEC055())
