...
_CATALOG_ONLY_INERT: tuple[tuple[str, str], ...] = (
    ...
    ("SEC023", "policy TO clause names a BYPASSRLS role (schema.bypassrls_roles)"),
    ...
    ("PERF003", "policy-predicate column indexes"),
    ("PERF005", "observed runtime seq-scans"),
    ("VIEW001", "views over RLS tables"),
    ("VIEW002", "non-security-barrier view over RLS table (schema.views)"),
