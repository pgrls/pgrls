...
def test_public_modules_declare_all() -> None:
    ...
    # docstring as importable destinations (`pgrls.violations`,
    # `pgrls.model`, `pgrls.rules`, `pgrls.fixers`) must declare
    # `__all__` so static linters and IDE autocomplete have an
    # explicit list of public names.
    import pgrls
    import pgrls.fixers
    import pgrls.model
    import pgrls.rules
