...
def test_snapshot_version_is_twenty_three():
    # v23 added per-view View.grants (relacl) for SEC052; v22 added
    # Table.in_publications for SEC051; v21 added per-table owner +
