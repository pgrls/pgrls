...
def test_snapshot_version_is_sixteen():
    # Bumped 15 → 16 to add SecdefFunction.execute_roles + owner_bypasses_rls
    # (for SEC042's anon-executable-SECDEF-bypass check). Pin so a future
    # bump is deliberate.
